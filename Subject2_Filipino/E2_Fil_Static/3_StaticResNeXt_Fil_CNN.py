    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/Subject2_Filipino/E2_Fil_Static/epochs/gpu/StaticResNeXt101_Fil_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './clean/Subject2_Filipino/E2_Fil_Static/data/'
...
final_model_name = './clean/Subject2_Filipino/E2_Fil_Static/models/gpu/StaticResNeXt101_Fil_50epoch.sav'
