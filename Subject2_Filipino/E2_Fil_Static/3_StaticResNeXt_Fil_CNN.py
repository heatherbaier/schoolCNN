    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/Subject2_Filipino/E2_Fil_Static/epochs/StaticResNeXt101_Fil_Epoch' + str(epoch_num) + '.sav'
...
final_model_name = './clean/Subject2_Filipino/E2_Fil_Static/models/StaticResNeXt101_Fil_10epoch.sav'
