...
y1314 <- read.csv("./clean/Subject2_Filipino/E2_Fil_Static/data/y1314_English.csv")
...
#  print(school)
  ...
  if (int == 0) {
      file.copy(files[i], "./clean/Subject2_Filipino/E2_Fil_Static/data/pass/")
  } else if (int == 1) {
      file.copy(files[i], "./clean/Subject2_Filipino/E2_Fil_Static/data/fail/")
  }
