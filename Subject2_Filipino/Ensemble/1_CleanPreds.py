...
# Static
static = pd.read_csv("./clean/Subject2_Filipino/Ensemble/data/StaticPreds.csv")
...
comb.to_csv("./clean/Subject2_Filipino/Ensemble/data/EnsemblePreds.csv", index = False)