    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/Subject2_Filipino/E3_Fil_StreetView/epochs/real/StreetViewResNeXt101_Filipino_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './clean/Subject2_Filipino/E3_Fil_StreetView/data/'
...
model_ft = joblib.load("./clean/Subject2_Filipino/E3_Fil_StreetView/epochs/StreetViewResNeXt101_Filipino_Epoch0.sav")
...
final_model_name = './clean/Subject2_Filipino/E3_Fil_StreetView/models/StreetViewResNeXt101_Filipino_10epoch.sav'
