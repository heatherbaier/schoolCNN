    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/Subject2_Filipino/E3_Fil_StreetView/epochs/realreal/StreetViewResNeXt101_Filipino_Epoch' + str(epoch_num) + '.sav'
...
final_model_name = './clean/Subject2_Filipino/E3_Fil_StreetView/models/realreal/StreetViewResNeXt101_Filipino_10epoch.sav'
