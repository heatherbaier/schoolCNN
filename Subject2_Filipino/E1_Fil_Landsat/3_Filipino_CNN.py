    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/Subject2_Filipino/E1_Fil_Landsat/epochs/LandsatResNeXt101_Filipino_Epoch' + str(epoch_num) + '.sav'
...
final_model_name = './clean/Subject2_Filipino/E1_Fil_Landsat/models/LandsatResNeXt101_Filipino_10epoch.sav'
