...
model_ft = joblib.load("./clean/Subject2_Filipino/E1_Fil_Landsat/models/gpu/LandsatResNeXt101_Filipino_50epoch.sav")
directory = "./clean/Subject2_Filipino/E1_Fil_Landsat/data/pass/"
...
pass_preds.to_csv("./clean/Subject2_Filipino/Ensemble/data/LandsatPassPreds_GPU.csv")



model_ft = joblib.load("./clean/Subject2_Filipino/E1_Fil_Landsat/models/gpu/LandsatResNeXt101_Filipino_50epoch.sav")
directory = "./clean/Subject2_Filipino/E1_Fil_Landsat/data/fail/"
transform = transforms.Compose([
	ImgAugTransform(),
	transforms.ToTensor(),
	transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
...
fail_preds.to_csv("./clean/Subject2_Filipino/Ensemble/data/LandsatFailPreds_GPU.csv")
