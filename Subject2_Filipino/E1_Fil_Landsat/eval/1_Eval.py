...
model_ft = joblib.load("./clean/Subject2_Filipino/E1_Fil_Landsat/models/LandsatResNeXt101_Filipino_10epoch.sav")
...
pass_preds.to_csv("./clean/Subject2_Filipino/Ensemble/data/LandsatPassPreds.csv")
...
fail_preds.to_csv("./clean/Subject2_Filipino/Ensemble/data/LandsatFailPreds.csv")
