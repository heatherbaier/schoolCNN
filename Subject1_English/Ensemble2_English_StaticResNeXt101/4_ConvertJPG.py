...
directory = "./clean/Subject1_English/Ensemble2_English_StaticResNeXt101/data/imagery/"
...
for filename in os.listdir(directory):
    ...
    new_name = "./clean/Subject1_English/Ensemble2_English_StaticResNeXt101/data/jpg/" + school_id + '.jpg'
    im.save(new_name)
