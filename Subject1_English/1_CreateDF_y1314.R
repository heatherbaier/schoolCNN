...
df6 <- read.csv("./clean/Subject1_English/y13-14_g6.csv")
head(df6)
...
# Write final CSV
write.csv(final_df, "./clean/Subject1_English/Ensemble1_English_LandsatResNeXt101/data/y1314_English.csv", row.names=FALSE)
write.csv(final_df, "./clean/Subject1_English/Ensemble2_English_StaticResNeXt101/data/y1314_English.csv", row.names=FALSE)
write.csv(final_df, "./clean/Subject1_English/Ensemble3_English_StreetViewResNeXt101/data/y1314_English.csv", row.names=FALSE)
