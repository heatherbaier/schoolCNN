...
model_ft = joblib.load("./clean/Subject4_Science/E3_Sci_StreetView/models/StreetViewResNeXt101_Sci_10epoch.sav")
...
pass_preds.to_csv("./clean/Subject4_Science/Ensemble/data/StreetViewPreds_GPU.csv")
