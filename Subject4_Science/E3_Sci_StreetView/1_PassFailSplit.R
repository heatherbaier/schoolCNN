...
y1314 <- read.csv("./clean/Subject4_Science/E3_Sci_StreetView/data/y1314_Science.csv")
...
#  print(school)
  ...
  if (int == 0) {
      file.copy(files[i], "./clean/Subject4_Science/E3_Sci_StreetView/data/pass/")
  } else if (int == 1) {
      file.copy(files[i], "./clean/Subject4_Science/E3_Sci_StreetView/data/fail/")
  }
