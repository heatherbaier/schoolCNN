...
y1314 <- read.csv("./clean/Subject4_Science/E1_Sci_Landsat/data/y1314_Science.csv")
...
#	print(int)
  ...
  if (int == 0) {
      file_name <- paste("./clean/Subject4_Science/E1_Sci_Landsat/data/pass/", id, "_", school$intervention, ".jpg", sep = '')
  } else if (int == 1) {
      file_name <- paste("./clean/Subject4_Science/E1_Sci_Landsat/data/fail/", id, "_", school$intervention, ".jpg", sep = '')
  }
