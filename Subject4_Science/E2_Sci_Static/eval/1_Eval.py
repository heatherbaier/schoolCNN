...
model_ft = joblib.load("./clean/Subject4_Science/E2_Sci_Static/models/StaticResNeXt101_Sci_50epoch.sav")
...
pass_preds.to_csv("./clean/Subject4_Science/Ensemble/data/StaticPreds_GPU.csv")
