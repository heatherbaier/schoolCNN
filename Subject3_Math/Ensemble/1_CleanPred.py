...
# Landsat
landsat_pass = pd.read_csv("./clean/Subject3_Math/Ensemble/data/LandsatPassPreds.csv")
landsat_pass = landsat_pass.drop(['Unnamed: 0'], axis = 1)
landsat_pass.head()
landsat_pass.shape

landsat_fail = pd.read_csv("./clean/Subject3_Math/Ensemble/data/LandsatFailPreds.csv")
