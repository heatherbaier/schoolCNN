...
y1314 <- read.csv("./clean/Subject3_Math/E2_Math_Static/data/y1314_Math.csv")
...
#  print(school)
  ...
  if (int == 0) {
      file.copy(files[i], "./clean/Subject3_Math/E2_Math_Static/data/pass/")
  } else if (int == 1) {
      file.copy(files[i], "./clean/Subject3_Math/E2_Math_Static/data/fail/")
  }
