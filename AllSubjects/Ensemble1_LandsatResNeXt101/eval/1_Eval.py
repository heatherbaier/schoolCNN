...
model_ft = joblib.load("./clean/AllSubjects/Ensemble1_LandsatResNeXt101/models/gpu/LandsatResNeXt101_10epoch.sav")
...
pass_preds.to_csv("./clean/AllSubjects/Ensemble/data/LandsatPassPreds_GPU.csv")
...
fail_preds.to_csv("./clean/AllSubjects/Ensemble/data/LandsatFailPreds_GPU.csv")
