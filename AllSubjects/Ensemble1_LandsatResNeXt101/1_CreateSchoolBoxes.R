...
sp <- readOGR("./clean/AllSubjects/Ensemble1_LandsatResNeXt/data/shp/y1314_AllSubjects_sp.shp")

sb <- create_boxes(sp)
							 
writeOGR(sb, dsn = "./clean/AllSubjects/Ensemble1_LandsatResNeXt/data/shp/y1314_AllSubjects_sb.shp", layer = "y1314_AllSubjects_sb", driver = "ESRI Shapefile", overwrite_layer = TRUE)
