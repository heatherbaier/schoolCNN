    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/AllSubjects/Ensemble3_StreetViewResNet152/epochs/gpu/StreetViewResNeXt101_Epoch' + str(epoch_num) + '.sav'
...
final_model_name = './clean/AllSubjects/Ensemble3_StreetViewResNet152/models/gpu/StreetViewResNeXt101_50epoch.sav'
