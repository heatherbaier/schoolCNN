...
y1314 <- read.csv("./clean/AllSubjects/Ensemble2_StaticResNeXt101/data/y1314_AllSubjects.csv")
...
#  print(school)
  ...
  if (int == 0) {
      file.copy(files[i], "./clean/AllSubjects/Ensemble2_StaticResNeXt101/data/pass/")
  } else if (int == 1) {
      file.copy(files[i], "./clean/AllSubjects/Ensemble2_StaticResNeXt101/data/fail/")
  }
