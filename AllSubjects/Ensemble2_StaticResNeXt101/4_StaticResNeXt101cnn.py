    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/AllSubjects/Ensemble2_StaticResNeXt101/epochs/gpu/StaticResNeXt101_Epoch' + str(epoch_num) + '.sav'
...
final_model_name = './clean/AllSubjects/Ensemble2_StaticResNeXt101/models/gpu/StaticResNeXt101_10epoch.sav'
