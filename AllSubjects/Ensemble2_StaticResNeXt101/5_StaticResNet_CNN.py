    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/AllSubjects/Ensemble2_StaticResNeXt101/epochs/resnset/StaticResNet_Epoch' + str(epoch_num) + '.sav'
...
final_model_name = './clean/AllSubjects/Ensemble2_StaticResNeXt101/models/resnet/StaticResNet_10epoch.sav'
